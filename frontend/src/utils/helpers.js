...
export function generatePDF(patient, formatDate, calcAge) {
  ...
  pw.document.write(`<!DOCTYPE html><html lang="es"><head>
    ...
    <style>
      body{font-family:Georgia,serif;margin:0;padding:30px;color:#293647;font-size:14px;}
      ...
      .foto-ph{width:90px;height:90px;border-radius:50%;background:linear-gradient(135deg,#1A989D,#405570);display:flex;align-items:center;justify-content:center;font-size:28px;font-weight:bold;color:white;flex-shrink:0;}
